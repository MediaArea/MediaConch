...
<<<<<<< HEAD
                                ...
                                <xsl:variable name="NonRepeatingElements">
                                    <xsl:for-each select="document('MatroskaSchema.xml')//element[@maxOccurs!='unbounded' or not(@maxOccurs)]"><!-- needs a correction is maxOccurs may be something other than 'unbounded' -->
                                        <xsl:value-of select="@id"/>
                                        <xsl:text> </xsl:text>
                                    </xsl:for-each>
                                </xsl:variable>
